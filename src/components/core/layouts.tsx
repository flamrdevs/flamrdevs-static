...
const Container = ((props) => {
	const [polymorphic, classes, root, margin, padding, rest] = splitProps(props, Polymorphic.Keys, Classes.Keys, ContainerKlass.Root.vk, reklass.Margin.rvk, reklass.Padding.rvk);
	return <Dynamic component={polymorphic.as ?? "div"} {...rest} class={Classes.x([ContainerKlass.Root(root), reklass.Margin(margin), reklass.Padding(padding)], classes)} />;
